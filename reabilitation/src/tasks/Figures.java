...
public class Figures extends AbstractTask {
	...
	private FiguresPanel panel;

	private JLabel onPause;

	public Figures(int width, int height, String text, Reabilitation reabilitation, String username,
	...
	public void showTask(boolean repeat) {
		...
		if (panel != null && repeat)
			...
			panel = new FiguresPanel(this.getWidth(), 440, diff, this);
