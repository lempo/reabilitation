...
public class Sudoku extends AbstractTask {
	private static final long serialVersionUID = -3949981831230940319L;
	public static int EASY = 30;
	public static int MIDDLE = 49;
	public static int HARD = 53;
	...
	public Sudoku(int width, int height, String text, Reabilitation reabilitation, String username,
	...
	public void showTask(boolean repeat) {
		...
		if (panel != null && repeat)
			...
			panel = new SudokuPanel(400, 400, diff, this);
