...
public class Words extends AbstractTask {
	...
	private WordsPanel panel;

	private JLabel onPause;

	public Words(int width, int height, String text, Reabilitation reabilitation, String username,
	...
	public void showTask(boolean repeat) {
		...
		if (panel != null && repeat)
			...
			panel = new WordsPanel(this.getWidth(), 400, diff, this);
